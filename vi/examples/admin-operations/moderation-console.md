---
slug: bang-dieu-phoi-kiem-duyet
---

# Bảng điều phối kiểm duyệt

Ví dụ này tạo một trang quản trị dành cho các bình luận đang chờ duyệt.
...
Tạo một page extension gắn với mục menu đó.
...
Khi người vận hành cần xem đầy đủ metadata, dùng data route thô `/data/blog_comment` làm liên kết kiểm tra bổ sung.
