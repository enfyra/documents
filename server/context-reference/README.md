...
- [Helpers & Cache](./helpers-cache.md) - `$ctx.$helpers` (JWT, bcrypt, file helpers, rate limiting) and `$ctx.$cache`
...
- **[Helpers & Cache](./helpers-cache.md)** - Utility functions (JWT, bcrypt, rate limiting) and Redis cache operations
