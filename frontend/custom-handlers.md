...
**📖 For complete context reference, see [Context Reference](../backend/context-reference.md)**

## Database Repository Methods

Each repository in `$ctx.$repos` provides full database access through the QueryEngine.

**📖 For complete database operations and examples, see [Context Reference](../backend/context-reference.md#database-access)**
...
**📖 For complete best practices including cache operations and API filtering, see [Context Reference](../backend/context-reference.md#best-practices)**
...
- **[Context Reference](../backend/context-reference.md)** - Complete $ctx object reference
