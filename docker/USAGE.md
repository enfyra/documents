...
### With external database and Redis (using DB_URI - Recommended):
...
### Server with cluster (multiple workers):
...
```
⚠️  WARNING: Port 6379 is already in use!
